...
export default function Inbox({
  ...
  return (
    <main className="px-40 pt-5 grid grid-rows-24 bg-secondary max-h-screen min-h-screen h-screen relative">
      <section className="header grid grid-cols-2 row-start-1 row-end-2">
      ...
      <section className="utils grid grid-cols-2 row-start-3 row-end-4 w-full">
      ...
      <section className="body row-start-5  row-span-22	">
